...
```
./lucind-lane-check.sh --file openspec/changes/<change-id>/spec-lens-c.md --budget 1000 \
...
```
./lucind-lane-check.sh --file openspec/changes/<change-id>/spec-lens-c.md
```
...
- [ ] **`spec-lens-c.md` exists, is under 1000 words excluding the verbatim blocks and the Citation Manifest, and carries `## Assumed requirements`, `## Live Spec Inventory`, and `## Citation Manifest`.**
