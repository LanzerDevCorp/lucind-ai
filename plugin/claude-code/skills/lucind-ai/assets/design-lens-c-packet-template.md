...
```
./lucind-lane-check.sh --file openspec/changes/<change-id>/design-lens-c.md --budget 1000 \
...
```
./lucind-lane-check.sh --file openspec/changes/<change-id>/design-lens-c.md
```
