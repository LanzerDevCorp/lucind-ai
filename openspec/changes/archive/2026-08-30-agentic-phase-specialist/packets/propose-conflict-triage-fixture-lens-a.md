---
id: propose-conflict-triage-fixture-lens-a
executor: agy
routed_by: candidate and approach lens of the three-lens propose fan-out
model: gemini-3.7-flash-high
allowed_paths: ["openspec/changes/conflict-triage-fixture/propose-lens-a.md"]
---

# Packet propose-conflict-triage-fixture-lens-a

**Tier:** B (auto-merge after audit)
**Worktree:** ../lucind-ai-worktrees/propose-conflict-triage-fixture-lens-a  ·  **Branch:** lucind/propose-conflict-triage-fixture-lens-a

## Goal

Produce `openspec/changes/conflict-triage-fixture/propose-lens-a.md`: the candidate selection, proposed technical approach, changes to system concepts, and architecture rationale for this change.
...
The proposal phase for `conflict-triage-fixture` is initiating. Lens B and lens C run in parallel against the same codebase and write to different files, so no lane races another. This lens owns candidate selection and core approach; the other two explore capability specs and risk/rollback.

## Preconditions

- `openspec/changes/conflict-triage-fixture/` exists (and `explore.md` exists if explore was run).
- `openspec/changes/conflict-triage-fixture/propose-lens-a.md` does not yet exist.
...
2. `openspec/changes/conflict-triage-fixture/explore.md` (if present).
...
Write exactly this skeleton to `openspec/changes/conflict-triage-fixture/propose-lens-a.md`:
...
`openspec/changes/conflict-triage-fixture/propose-lens-a.md` only. Create no other file.
