---
id: propose-conflict-triage-fixture-lens-b
executor: agy
routed_by: capability impact and delta specs lens of the three-lens propose fan-out
model: gemini-3.7-flash-high
allowed_paths: ["openspec/changes/conflict-triage-fixture/propose-lens-b.md"]
---

# Packet propose-conflict-triage-fixture-lens-b

**Tier:** B (auto-merge after audit)
**Worktree:** ../lucind-ai-worktrees/propose-conflict-triage-fixture-lens-b  ·  **Branch:** lucind/propose-conflict-triage-fixture-lens-b

## Goal

Produce `openspec/changes/conflict-triage-fixture/propose-lens-b.md`: user capability impact, modified/added capabilities, and delta specification requirements and scenarios for this change.
...
The proposal phase for `conflict-triage-fixture` is initiating. Lens A and lens C run in parallel against the same codebase and write to different files, so no lane races another.

## Preconditions

- `openspec/changes/conflict-triage-fixture/` exists (and `explore.md` exists if explore was run).
- `openspec/changes/conflict-triage-fixture/propose-lens-b.md` does not yet exist.
...
Write exactly this skeleton to `openspec/changes/conflict-triage-fixture/propose-lens-b.md`:
...
`openspec/changes/conflict-triage-fixture/propose-lens-b.md` only. Create no other file.
