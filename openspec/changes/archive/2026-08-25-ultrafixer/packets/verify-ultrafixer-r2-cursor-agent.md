---
id: verify-ultrafixer-r2-cursor-agent
...
# Packet verify-ultrafixer-r2-cursor-agent

**Tier:** A (human merge)
**Worktree:** ../lucind-ai-worktrees/verify-ultrafixer-r2-cursor-agent  ·  **Branch:** lucind/verify-ultrafixer-r2-cursor-agent
