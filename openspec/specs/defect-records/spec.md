# Defect Records Specification

## Purpose

Persist durable records of non-critical, non-blocking pre-existing defects in the SQLite ledger (schema v8) and provide query and CLI inspection APIs without modifying workspace code.
