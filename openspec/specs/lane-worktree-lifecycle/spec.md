# Lane Worktree Lifecycle Specification

## Purpose

Define explicit force parameter handling and idempotent automated teardown for lane worktree lifecycle operations.
